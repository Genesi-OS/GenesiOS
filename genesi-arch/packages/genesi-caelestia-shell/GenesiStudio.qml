            ...
            Item {
                ...
                readonly property var tables: ({
                    ...
                    "widgets": [
                        ...
                        { kind: "amount", section: "background", key: "widgets.weather.scale", label: qsTr("Size"), from: 0.5, to: 2.5, step: 0.05 },
                        ...
                        { kind: "amount", section: "background", key: "widgets.forecast.scale", label: qsTr("Size"), from: 0.5, to: 2.5, step: 0.05 },
                        { kind: "head", label: qsTr("NOW PLAYING") },
                        ...
                        { kind: "amount", section: "background", key: "widgets.media.scale", label: qsTr("Size"), from: 0.5, to: 2.5, step: 0.05 },
                        ...
                        { kind: "amount", section: "background", key: "widgets.cpu.scale", label: qsTr("Size"), from: 0.5, to: 2.5, step: 0.05 },
                        ...
                        { kind: "amount", section: "background", key: "widgets.memory.scale", label: qsTr("Size"), from: 0.5, to: 2.5, step: 0.05 },
                        ...
                        { kind: "amount", section: "background", key: "widgets.storage.scale", label: qsTr("Size"), from: 0.5, to: 2.5, step: 0.05 },
                        ...
                        { kind: "amount", section: "background", key: "widgets.network.scale", label: qsTr("Size"), from: 0.5, to: 2.5, step: 0.05 },
                        ...
                        { kind: "amount", section: "background", key: "widgets.battery.scale", label: qsTr("Size"), from: 0.5, to: 2.5, step: 0.05 },
                        ...
                        { kind: "amount", section: "background", key: "widgets.calendar.scale", label: qsTr("Size"), from: 0.5, to: 2.5, step: 0.05 },
                        ...
                        { kind: "amount", section: "background", key: "widgets.analogClock.scale", label: qsTr("Size"), from: 0.5, to: 2.5, step: 0.05 },
                        ...
                        { kind: "amount", section: "background", key: "widgets.workspaces.scale", label: qsTr("Size"), from: 0.5, to: 2.5, step: 0.05 },
                        ...
                        { kind: "amount", section: "background", key: "widgets.notifications.scale", label: qsTr("Size"), from: 0.5, to: 2.5, step: 0.05 },
                        ...
                        { kind: "amount", section: "background", key: "widgets.uptime.scale", label: qsTr("Size"), from: 0.5, to: 2.5, step: 0.05 },
                        ...
                        { kind: "amount", section: "background", key: "widgets.greeting.scale", label: qsTr("Size"), from: 0.5, to: 2.5, step: 0.05 },
                        { kind: "head", label: qsTr("DIGITAL CLOCK") },
                        { kind: "switch", section: "background", key: "widgets.digitalClock.enabled", label: qsTr("On") },
                        { kind: "choice", section: "background", key: "widgets.digitalClock.position", label: qsTr("Corner"), options: [{ id: "top-left", label: qsTr("TL") }, { id: "top-centre", label: qsTr("T") }, { id: "top-right", label: qsTr("TR") }, { id: "mid-left", label: qsTr("L") }, { id: "centre", label: qsTr("C") }, { id: "mid-right", label: qsTr("R") }, { id: "bottom-left", label: qsTr("BL") }, { id: "bottom-centre", label: qsTr("B") }, { id: "bottom-right", label: qsTr("BR") }] },
                        { kind: "amount", section: "background", key: "widgets.digitalClock.scale", label: qsTr("Size"), from: 0.5, to: 2.5, step: 0.05 }
                    ],
                    "system": [
