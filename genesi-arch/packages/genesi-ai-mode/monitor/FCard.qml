/*
 * Genesi AI Mode Monitor — inner surface card for the Automations canvas graphite
 * palette (copied from Forge). Soft lift gradient, 1px border, optional hover
 * lift and accent ring when active. Shader-free.
 */
import QtQuick
