/*
 * Genesi AI Mode Monitor — a block type in the Automations palette (copied from
 * Forge). Drag onto the canvas to place it (shared ghost owned by
 * AutomationCanvas), or click to add at the default spot.
 */
import QtQuick
