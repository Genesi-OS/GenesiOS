...
complete -c genesi-mesh -n __fish_use_subcommand -a use         -d 'Which Turbo this machine uses (root)'
...
complete -c genesi-mesh -n '__fish_seen_subcommand_from use' -a 'auto local'
