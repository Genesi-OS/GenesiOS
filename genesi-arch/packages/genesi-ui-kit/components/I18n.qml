...
Item {
    ...
    readonly property var _d: ({
        "en": {
            ...
            "mesh.missingTitle": "Mesh is not installed on this machine",
            "mesh.subtitle": "Pool the video memory of several machines to run a model that would not fit on any one of them.",
            "mesh.missingBody": "It is an optional package. Install it on every machine you want to pool, then come back here.",
            ...
            "snap.stUnavailableSub": "Snapshots need a Btrfs root filesystem, and this install is not on one, so protection is off. Reinstalling Genesi with the default Btrfs layout enables it.",
        ...
        "pt": {
            ...
            "mesh.missingTitle": "O Mesh não está instalado nesta máquina",
            "mesh.subtitle": "Junte a memória de vídeo de várias máquinas para rodar um modelo que não caberia em nenhuma delas sozinha.",
            "mesh.missingBody": "É um pacote opcional. Instale em cada máquina que você quer juntar e volte aqui.",
            ...
            "snap.stUnavailableSub": "Os snapshots precisam de uma raiz Btrfs, e esta instalação não está em uma, então a proteção está desligada. Reinstalar o Genesi com o layout Btrfs padrão habilita.",
