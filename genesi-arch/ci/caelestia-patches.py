...
def patch_topbar(release):
    ...
    block = (
        ...
        "    // The system tray. Turning this bar on collapses caelestia's\n"
        "    // rail, which is where the tray lived; which icons show is\n"
        "    // still caelestia's own bar.tray.hiddenIcons.\n"
