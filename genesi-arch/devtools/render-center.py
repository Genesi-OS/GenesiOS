...
SECTIONS = {
    ...
    "desktop": {
        "available": True,
        "clock": {"enabled": True, "scale": 1.4, "position": "middle-center",
                  "invertColors": False, "background": True,
                  "backgroundOpacity": 0.7, "shadow": True},
        "visualiser": {"enabled": True, "autoHide": True, "blur": False,
                       "rounding": 1.4, "spacing": 0.8},
        "wallpaper": True, "transitionDuration": 450,
    },
    "console": {
    ...
    "appearance": {
        ...
        "scales": {"rounding": 1.25, "spacing": 1.0, "padding": 1.1,
                   "font": 1.0, "anim": 1.0},
        "transparency": {"enabled": True, "base": 0.82, "layers": 0.35},
        "fonts": {"body": "Rubik", "mono": "JetBrains Mono",
                  "available": ["Cantarell", "DejaVu Sans", "Fira Sans",
                                "IBM Plex Sans", "Inter", "JetBrains Mono",
                                "Noto Sans", "Rubik", "Ubuntu"]},
    ...
    "ai": {
        "available": True, "turbo": True,
        "voice": {"available": True, "installed": False, "ready": False,
                  "download_mb": 336,
                  "missing": [{"name": "kokoro-onnx",
                               "how": "pip install --user kokoro-onnx",
                               "why": "the synthesiser itself"}]},
        "cloud": {"available": True, "configured": True, "provider": "openai",
                  "model": "gpt-4o-mini", "key_tail": "…8f2c",
                  "use_for": "manual"},
